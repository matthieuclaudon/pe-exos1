...
# %% [markdown]
# Les données sont rentrées en *Unicode* car elles ne sont pas homogènes. 

# %% [markdown]
# ### Question 3 :

# %%
df = pd.DataFrame(tab, columns=['names', 'speed', 'lifespan'])
df
...
# %%
df.iloc[2]['lifespan'], type(df.iloc[2]['lifespan'])

# %% [markdown]
# `lifespan` est une chaîne de caractères. 

# %% [markdown]
# ### Question 5 :

# %%
df.iloc[2]['names'], type(df.iloc[2]['names'])

# %% [markdown]
# Là encore, `names` est une chaîne de caractères, mais c'est normal au vu de la nature de l'objet. 

# %% [markdown]
# ### Question 6 :

# %%
df.iloc[2, 0] = 'grey elephant'

# %%
df.iloc[2][0], type(df.iloc[2][0])
...
# %% [markdown]
# Toutes les colonnes sont des `object`.
...
# %% [markdown]
# Maintenant, le `dtype` n'est plus `<U32` mais `object`.
...
# %% [markdown]
# On a bien modifié les types des deux dernières colonnes. 
